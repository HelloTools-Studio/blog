...
const url = `https://blog.yeeee.ml`
const dirname = path.dirname(fileURLToPath(import.meta.url))

const feed = new Feed({
  title: 'HelloTools Team Blog',
  description: 'The official blog for HelloTools',
  id: url,
  link: url,
  language: 'zh-cn',
  image: 'https://yeeee.ml/logo.png',
  favicon: `${url}/favicon.ico`,
  copyright: 'Copyright (c) 2022-present, HelloTools'
})
